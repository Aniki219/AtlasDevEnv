...
static class MyHierarchyIcons {
	...
	static Dictionary<Type, GUIContent> typeIcons = new Dictionary<Type, GUIContent>() {
        { typeof(StateBehavior), EditorGUIUtility.IconContent( "Assets/_Project/Editor/Icons/BehaviorIcon.png" ) },
        // { typeof(State), EditorGUIUtility.IconContent( "d_winbtn_mac_min" ) },
        // { typeof(StateTransition), EditorGUIUtility.IconContent( "d_winbtn_mac_max" ) },
		// ...
	};
